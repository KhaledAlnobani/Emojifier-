...
def plot_confusion_matrix(y_true, y_pred, labels=None, normalize=False, title='Confusion matrix'):
    ...
    This uses sklearn's ConfusionMatrixDisplay for a clean, minimal display.
    """
    ...
    disp = getattr(__import__('sklearn.metrics', fromlist=['ConfusionMatrixDisplay']),
                 'ConfusionMatrixDisplay').from_predictions(
        y_true, y_pred, display_labels=labels, normalize=normalize
    )
